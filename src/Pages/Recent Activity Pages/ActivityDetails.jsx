...
import { ArrowLeft, Clock, User, Activity, BarChart3, Star, Eye, Download } from 'lucide-react';

const ActivityDetails = () => {
  const id = "1"; // Mock ID for demo purposes
  
  // In a real app, you'd fetch this data based on the ID
  const activities = [
    { id: 1,  user: 'Bamidele John',action: 'Created new project', time: '2 hours ago', details: 'Created "E-commerce Platform" with React and Node.js backend', category: 'Project', priority: 'High' },
    { id: 2,  user: 'Maranatha James', action: 'Updated dashboard', time: '4 hours ago', details: 'Added new analytics widgets and performance metrics', category: 'Dashboard', priority: 'Medium' },
    { id: 3,  user: 'Kaleo Ejisun', action: 'Completed task', time: '6 hours ago', details: 'Finished implementing user authentication system', category: 'Development', priority: 'High' },
    { id: 4,  user: 'Sarah Wilson', action: 'Added new user', time: '8 hours ago', details: 'Onboarded new team member with admin privileges', category: 'User Management', priority: 'Low' },
    { id: 5,  user: 'Bukayo Saka',  action: 'Generated report', time: '1 day ago', details: 'Created quarterly performance analysis report', category: 'Reports', priority: 'Medium' },
  ];
  ...
  const getPriorityColor = (priority) => {
    switch(priority) {
      case 'High': return 'bg-gradient-to-r from-red-100 to-pink-100 text-red-700 border border-red-200';
      case 'Medium': return 'bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-700 border border-yellow-200';
      case 'Low': return 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-200';
  ...
  const getCategoryIcon = (category) => {
    ...
    switch(category) {
      case 'Project': return <Star className={iconClass} />;
      case 'Dashboard': return <BarChart3 className={iconClass} />;
      case 'Development': return <Activity className={iconClass} />;
      case 'User Management': return <User className={iconClass} />;
      case 'Reports': return <Eye className={iconClass} />;
          ...
          <div className="flex items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-600">Comprehensive activity analysis</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/20 shadow-xl overflow-hidden">
            ...
            <div className="relative">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-2">{activity.action}</h2>
                    <p className="text-indigo-100 text-lg">by {activity.user}</p>
                  </div>
                </div>
                <span className={`inline-flex items-center px-4 py-2 rounded-2xl text-sm font-semibold ${getPriorityColor(activity.priority)}`}>
          ...
          <div className="p-8">
              ...
              <div className="group bg-gradient-to-br from-white to-gray-50 p-6 rounded-3xl border border-gray-200 hover:border-indigo-300 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-100/50 hover:-translate-y-1">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900">{activity.user}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-gradient-to-br from-white to-gray-50 p-6 rounded-3xl border border-gray-200 hover:border-indigo-300 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-100/50 hover:-translate-y-1">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900">{activity.category}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-3xl border border-gray-200 mb-8">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">{activity.details}</p>
            </div>
